...
tipo_menu = create_custom_option_menu(tipo_var, ["Permutaciones", "Combinaciones"], "#FFB6C1", "black")
tk.Label(root, text="Selecciona tipo:", font=fuente, bg="#F08080").pack(pady=5)
tipo_menu.pack(pady=5)

repeticion_menu = create_custom_option_menu(repeticion_var, ["Con Repetición", "Sin Repetición"], "#FFB6C1", "black")
tk.Label(root, text="Selecciona repetición:", font=fuente, bg="#F08080").pack(pady=5)
repeticion_menu.pack(pady=5)



calcular_btn = tk.Button(root, text="Calcular", command=calcular, font=fuente, bg="#E0FFFF", fg="black")
